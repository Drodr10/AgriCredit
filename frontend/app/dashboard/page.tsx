              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 flex items-center justify-between">
                   <div className="flex flex-col">
                     <span className="text-[10px] font-black text-green-700 uppercase tracking-widest">AI Score: 92/100</span>
                     <Link 
                       href={`/apply?farmId=${farm.id}`}
                       className="text-xs font-black text-slate-900 hover:text-green-800 transition-colors uppercase mt-1 flex items-center gap-1"
                     >
                       APPLY FOR CREDIT
                   ...
                   <Link href={`/report?id=${farm.id}`} className="text-slate-300 group-hover:text-green-800 transition-all group-hover:translate-x-1">
...
function LenderView({ userData }: { userData: any }) {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50/60 to-white text-slate-900 p-8 sm:p-12 font-sans relative">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-500/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="max-w-7xl mx-auto">
        <header className="mb-16 border-b border-blue-100 pb-8">
          <h1 className="text-4xl font-black tracking-tighter mb-4 uppercase bg-gradient-to-r from-blue-900 to-indigo-600 bg-clip-text text-transparent">
            Lender <span className="italic text-blue-500">Command Center</span>
          </h1>
        ...
        <div className="bg-white/50 border-2 border-dashed border-blue-100 rounded-[3rem] p-24 text-center shadow-sm">
          <div className="bg-blue-50 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-8 ring-1 ring-blue-100">
             <svg className="w-10 h-10 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
             </svg>
          </div>
          <h2 className="text-3xl font-bold mb-4 text-slate-900">Institutional Portal Integrated</h2>
